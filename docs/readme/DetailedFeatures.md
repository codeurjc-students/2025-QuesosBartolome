## Detailed Features
Below we present the features that have already been implemented on the website, as well as those planned for future versions.
...
|----------|-----------------|
| Unregistered users | -View cheeses, their characteristics, and reviews <br> -See the "About Us" section <br> -View profiles of review authors <br> -Register <br> -Log in |
