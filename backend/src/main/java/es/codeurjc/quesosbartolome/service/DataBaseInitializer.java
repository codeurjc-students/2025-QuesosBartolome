...
public class DataBaseInitializer {
        ...
        public void init() throws IOException, URISyntaxException {
                ...
                // Create Reviews for Semicurado cheese
                Review review1 = new Review(5,
                                "¡Excelente queso! Sabor equilibrado y textura perfecta. Ideal para tapas.", user1,
                                semicurado);
                ...
                // Add reviews to user and cheese lists
                user1.getReviews().add(review1);
                user2.getReviews().add(review2);
                user2.getReviews().add(review4);
                userAdmin.getReviews().add(review3);
                
                semicurado.getReviews().add(review1);
                semicurado.getReviews().add(review2);
                semicurado.getReviews().add(review3);
                semicurado.getReviews().add(review4);
